...
/*------------------------------------------------------------------------------
** The Asset Management object instance attributes.
**
...
** ABP_PNAM_IA_LOCATION    - Asset location according to "twelve level tree
**                           format" or "Slot and subslot number format".
...
#define ABP_PNAM_IA_LOCATION     3
#define ABP_PNAM_IA_ANNOTATION   4
#define ABP_PNAM_IA_ORDER_ID     5
#define ABP_PNAM_IA_AM_SW_REV    6
#define ABP_PNAM_IA_AM_HW_REV    7
#define ABP_PNAM_IA_SERIAL       8
#define ABP_PNAM_IA_IM_SW_REV    9
#define ABP_PNAM_IA_DEVICE_ID    10
#define ABP_PNAM_IA_TYPE_ID      11
#define ABP_PNAM_IA_IM_HW_REV    12
...
#define ABP_PNAM_IA_LOCATION_DS     ( 16 * ABP_UINT8_SIZEOF )
